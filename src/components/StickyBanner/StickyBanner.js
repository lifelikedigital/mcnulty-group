  ...
  (function () {
    ...
    function getBannerOffsets(element) {
      ...
      if (element.targetIn) {
        ...
        element.offsetIn =
          boundingClientRect.top + windowTop + boundingClientRect.height;
      }
      ...
      if (element.targetOut) {
        ...
        element.offsetOut =
          boundingClientRect.top + windowTop - window.innerHeight;
      }
    ...
    function getScrollTop(element) {
      ...
      var windowTop =
        element.scrollElement.scrollTop || document.documentElement.scrollTop;
