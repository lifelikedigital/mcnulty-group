...
function addProgressBar() {
  ...
  html.setAttribute('class', 'reading-progressbar js-reading-progressbar');
  html.setAttribute('max', '100');
  html.setAttribute('value', '0');

  const div = document.createElement('div');
  div.setAttribute(
    'class',
    'reading-progressbar__fallback js-reading-progressbar__fallback'
  );
